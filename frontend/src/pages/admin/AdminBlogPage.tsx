    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 border-2 border-dashed rounded-2xl">
          ...
          <Link to="/admin/blog/new"><Button className="bg-navy-900 text-white gap-2 mt-4"><Plus className="w-4 h-4" /> Create First Post</Button></Link>
        </div>
      ) : (
          ...
          {blogs?.map((blog, i) => (
            <motion.div key={blog._id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }}
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0 flex-wrap justify-end">
                ...
                <Link to="/admin/blog/$id/edit" params={{ id: blog._id }}>
