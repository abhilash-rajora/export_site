        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="font-display font-bold text-xl text-white mb-2">
              {require2FA ? 'Check Your Email' : 'Admin Access'}
            </h2>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-green-400/70 text-xs mt-0.5">
                    Check your email inbox. Valid for 10 minutes.
                  </p>
                </div>
              </motion.div>
            )}
              ...
              <>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="bg-white/10 border-white/20 rounded-xl text-white placeholder:text-white/30"
                  />
                </div>
                <div className="space-y-1.5">
            ...
            >
              {isLoading ? (
                <><Loader2 className="mr-2 w-4 h-4 animate-spin" />
                  {require2FA ? 'Verifying...' : 'Sending OTP...'}
                </>
              ) : (
                require2FA ? 'Verify OTP' : 'Send OTP'
              )}
            </Button>
          </form>
          ...
          <div className="flex items-center justify-between mt-5 text-sm">
            {!require2FA ? (
              <Link to="/admin/forgot-password" className="text-white/50 hover:text-white transition">
                Forgot Password?
              </Link>
            ) : (
              <div className="flex items-center justify-between w-full">
                <button
                  type="button"
                  onClick={() => { setRequire2FA(false); setOtpSent(false); setOtp(''); }}
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="text-gold-400 hover:text-gold-300 transition text-sm font-semibold"
                >
                  Resend OTP
                </button>
              </div>
