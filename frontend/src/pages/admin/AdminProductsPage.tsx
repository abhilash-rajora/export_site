  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-display text-3xl font-extrabold text-sidebar-foreground tracking-tight">Products</h1>
      ...
      <div className="relative mb-6 max-w-sm">
        ...
        <Input
          ...
          className="pl-9 bg-white/5 border-sidebar-border text-sidebar-foreground placeholder:text-sidebar-foreground/30"
        />
      </div>
      ...
      <div className="bg-white/5 rounded-xl border border-sidebar-border overflow-hidden">
        {isLoading ? (
          ...
          <div className="py-20 text-center">
            <Package className="w-10 h-10 text-sidebar-foreground/20 mx-auto mb-3" />
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sidebar-foreground/40 text-xs">Min. {product.minOrderQty} units</p>
                        </div>
                      </div>
                    </td>
