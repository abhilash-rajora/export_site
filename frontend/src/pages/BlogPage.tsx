...
export default function BlogPage() {
  useSeo('blog', {
    ...
    description: "Stay updated with the latest export tips, industry news and market trends from WExports — India's trusted export partner.",
    keywords: 'export blog india, trade insights, export tips, indian exporter blog, wexports blog',
      ...
      <div className="bg-navy-900 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/products"><Button className="bg-gold-500 hover:bg-gold-400 text-navy-900 font-bold px-8">Browse Products</Button></Link>
            <Link to="/enquiry"><Button variant="outline" className="border-white/30 text-white hover:bg-white/10 px-8">Contact Us</Button></Link>
          </div>
        </div>
      </div>
    </div>
